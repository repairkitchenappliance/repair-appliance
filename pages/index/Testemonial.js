        ...
        <section className="mx-6 sm:mx-8 mb-10 md:mb-0 md:mx-20 md:py-20">
            <div className="flex flex-col text-gray-700 items-start mb-5">
                ...
                <snap className="text-gray-700 mt-2 leading-none w-5/5 md:w-3/5">
                    We have been working as a kitchen Appliances Repair company in dubai for the past 10 years and we have thousends of satesfied clients form our repairing work.
                    We repair Washing Machines, Dish Washers, and Dryers of different multinational brands in dubai. Kitchen appliance repair company has a team of professionals on whome you can trust.
                </snap>
            </div>
